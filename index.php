    ...
    <div class="container-large"
        ...
        <div class="row">
            ...
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bankimg4.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
...
<div class="foot">
        <footer class="bg-light text-center text-lg-start">
            <!-- Copyright -->
            <div class="text-center p-3" style="background-color:black;text-align:center;color:white;">
                © 2022 Copyright - Made by <strong>Shruni</strong> 
